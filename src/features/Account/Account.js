...
import { InputTextInactive, InputTextInactiveNoError } from "../../shared/components/Input"
    ...
    return(
        <MainContainer>
            <View style={styles.mainCtn}>
                ...
                <SettingItemComponent label="Activate to Business Acc" handlePress={()=>handleShowActivate()} style={styles.btnCtn} iconStatus={false}/>
