        ...
        <MainContainer>
            <View style={styles.timelineCtn}>
                ...
                <View style={{ alignSelf: 'stretch' }}>
                    <CommentExtActive comments={comments} handleCommentChange={handleCommentChange} value={comment} isButtonSendActive={isButtonSendActive} buttonLabel={'Send'} handleOnClickSend={handleOnClickSend} charLength={comment.length} maxLength={280} avatar={profile.profileImage} isLogin={user.roleId !== 0 ? true : false} />
                </View>
            </View>
        </MainContainer>
    )
